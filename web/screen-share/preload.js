  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    $bridge.onOpen((data) => {
      ...
      if (data.strings) {
        ...
        title.innerText = data.requesterUrl ? `Choose what to share with ${data.requesterUrl}` : s.shareYourScreen
        document.querySelector('[data-tab="screen"]').textContent = s.screen
        document.querySelector('[data-tab="window"]').textContent = s.window
        if (audioCheckbox.parentElement.querySelector('label')) {
          audioCheckbox.parentElement.querySelector('label').textContent = s.shareAudio
        }
