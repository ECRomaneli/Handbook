      ...
      <div class="sync-card">
        <div class="sync-card-header">
          <div class="d-flex align-items-center">
            ...
            <span class="sync-card-title">{{ $i18n.preferences.sync.localFileTitle }}</span>
          </div>
          <span class="sync-card-description">{{ $i18n.preferences.sync.localFileDesc }}</span>
        </div>
        <div class="sync-card-actions">
          <button class="btn btn-sm btn-secondary" :disabled="loading" @click="importFromFile">{{ $i18n.preferences.sync.import }}</button>
          <button class="btn btn-sm btn-secondary" :disabled="loading" @click="exportToFile">{{ $i18n.preferences.sync.export }}</button>
        </div>
      </div>
      ...
      <div class="sync-card">
        <div class="sync-card-header">
          <div class="d-flex align-items-center">
            ...
            <span class="sync-card-title">{{ $i18n.preferences.sync.githubGistTitle }}</span>
          </div>
        ...
        <div class="sync-card-body">
          <div class="sync-field">
            ...
            <div class="input-group input-group-sm">
              ...
              <button class="btn btn-secondary btn-sm" @click="showToken = !showToken" :title="showToken ? $i18n.preferences.sync.hide : $i18n.preferences.sync.show">
          ...
          <div class="sync-field">
            <label>{{ $i18n.preferences.sync.gistId }} <span class="text-muted smallest">{{ $i18n.preferences.sync.gistIdHint }}</span></label>
            <input type="text" class="form-control form-control-sm" v-model="gist.id" :placeholder="$i18n.preferences.sync.gistIdPlaceholder" @change="saveGistSettings">
          </div>
        </div>
        <div class="sync-card-actions">
