app.component('Pages', {
  template: /*html*/ `
    <div v-if="pages" class="d-flex flex-column" style="margin-top: -4px;">
        <div class="my-2">
            <page-table :pages="pages" @update="storePages" @remove="storePages"></page-table>
        </div>
        <div class="page-card page-card-add" @click="$emit('navigate', 'sync')">
