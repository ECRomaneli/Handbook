...
export const ru: Strings = {
  ...
  menu: {
    ...
    searchOnGoogle: 'Поиск в Google',
    searchWithGemini: 'Поиск с Gemini',
    translate: 'Перевести',
  ...
  preferences: {
    ...
    settings: {
      ...
      contentProtection: 'Защита содержимого',
      contentProtectionDesc: 'Предотвращает захват содержимого окон приложения средствами демонстрации экрана или скриншотов.',
      ...
      googleApiKeyDesc: 'Укажите ключ API Google Maps для точной геолокации. Без него запросы местоположения могут не пройти или вернуть неточные данные. Получите ключ из консоли Google Cloud с включённым API геолокации.',
      rightMarginWhenMaximized: 'Правое поле при развёрнутом окне',
      rightMarginWhenMaximizedDesc: 'Windows удаляет пиксели от краёв окна при его развёртывании. Этот параметр добавляет правое поле как решение для предотвращения достижения содержимым края окна.',
    ...
    quickActions: {
      search: 'Поиск быстрых действий...',
      label: 'Название',
      labelPlaceholder: 'Имя меню',
      url: 'URL',
      urlPlaceholder: 'https://example.com/search?q=${encodedText}',
      addItem: 'Добавить быстрое действие',
      remove: 'Удалить',
      drag: 'Перетащите для перестановки',
      emptyTitle: 'Нет быстрых действий',
      emptyDesc: 'Добавьте первое быстрое действие для начала работы',
      variablesTitle: 'Доступные переменные',
      variablesDesc: 'Используйте эти переменные в шаблоне URL. Они будут заменены фактическими значениями при выполнении поиска.',
      variables: {
        language: 'Код языка приложения (напр. "ru")',
        region: 'Код региона приложения (напр. "RU"), пусто если недоступно',
        locale: 'Полный код локали приложения (напр. "ru-RU")',
        encodedText: 'Выделенный текст, URL-кодированный',
        text: 'Выделенный текст, необработанный (без кодирования)',
        encodedLink: 'URL ссылки элемента, кодированный',
        link: 'URL ссылки элемента, на котором вызвано контекстное меню, пусто если не ссылка',
      },
    },
