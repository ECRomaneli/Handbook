...
class NotificationModal extends Modal {
    ...
    static #ROOT_PATH = path.join(Path.WEB, 'notification')

    /** @type {NotificationOptions} */
    #options = null

    constructor() {
        super({ filePath: path.join(NotificationModal.#ROOT_PATH, 'index.html'), disableParentEvents: !true, lockModalToWindow: true })
        ...
        this.setWindowOptions({
            ...
            webPreferences: { preload: path.join(NotificationModal.#ROOT_PATH, 'preload.js') }
        })
