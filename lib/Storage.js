...
import { Settings, DefaultSettings, Permission } from './config/Constants.js';
...
class Vault {
    ...
    static #store = (() => {
        ...
        const store = new Store(Vault.#isDebug ? void 0 : { encryptionKey: k, fileExtension: '.bin' })
...
const executeIfPreferences = (e, fn) => {
    const webContents = PreferencesManager.getWindow()?.webContents
