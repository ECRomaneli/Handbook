...
class HandbookManager {
    ...
    #setupAccelerators() {
        const ifVisible = (windowAction) => () => {
            ...
            win?.isVisible() && win.isFocused() && windowAction(win)
        }
        ...
        const pageMenu = new MenuItem({ label: 'Page', submenu: [
            ...
            { label: 'Dismiss', visible: false, click: ifVisible(win => win.closeFindbar()), accelerator: 'Esc' },
    ...
    #createPageSubmenu(page) {
        ...
        return this.#isCurrentPage(page) ?
            [
                ...
                { type: 'separator' },
                { label: 'Find...', click: () => win.openFindbar() },
