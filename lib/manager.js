const { Tray, Menu, dialog, globalShortcut, ipcMain, clipboard, app, nativeTheme, MenuItem } = require('electron')
    ...
    #createPageSubmenu(page) {
        ...
        return this.#isCurrentPage(page) ?
            [
                ...
                { label: 'Close', click: () => page.closeWindow(), accelerator: 'CommandOrControl+Q' },
                { type: 'separator' },
                { label: 'Find...', click: () => win.openFindbar(), accelerator: 'CommandOrControl+F' },
                { label: 'Dismiss', visible: false, click: () => win.closeFindbar(), accelerator: 'Esc' },
                { label: 'Back', click: () => win.webContents.goBack(), accelerator: 'CommandOrControl+Left' },
                { label: 'Forward', click: () => win.webContents.goForward(), accelerator: 'CommandOrControl+Right' },
                { type: 'separator' },
                { label: 'Refresh', click: () => win.reload(), accelerator: 'CommandOrControl+R' },
                { label: 'Reload', click: () => win.reset() },
                { type: 'separator' },
                { label: 'Copy URL', click: () => clipboard.writeText(win.webContents.getURL()) },
                { label: 'Open DevTools', click: () => win.webContents.openDevTools(), accelerator: 'CommandOrControl+Shift+I' },
            ] : 
            [
                { label: 'Show', click: () => this.#selectPage(page) },
                { label: win.isMuted() ? 'Unmute' : 'Mute', click: () => win.toggleMute(), accelerator: 'CommandOrControl+M' },
                { label: 'Close', click: () => page.closeWindow(), accelerator: 'CommandOrControl+Q' },
            ]
